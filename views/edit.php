<form action="/tasks/update" method="post">
    <div class="form-row pt-4">
      <div class="form-group col-md-6">
        ...
        <input type="username" class="form-control" id="inputUsername" name="inputUsername" value="<?=$data['username']?>" required>
      </div>
      <div class="form-group col-md-6">
        <label for="inputEmail">Email</label>
        <input type="email" class="form-control" id="inputEmail" name="inputEmail" value="<?=$data['email']?>" required>
      </div>
    </div>
